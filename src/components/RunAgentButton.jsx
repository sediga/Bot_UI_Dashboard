...
export default function RunAgentButton() {
  ...
  return (
    <div className="p-4 bg-white rounded shadow max-w-md mx-auto text-center">
      <h2 className="text-lg font-semibold mb-2">Flowtra Agent</h2>

      {status === "idle" && (
        <>
          <p className="mb-4 text-gray-700">Download and run the Flowtra Agent to enable local automation.</p>
          <button
      ...
      {status === "running" && (
        <p className="text-sm text-green-600 mt-4 font-medium">
          ✅ Flowtra Agent is running and connected!
        </p>
      )}
    </div>
  );
